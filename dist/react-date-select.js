...
var DaySelect = function (_Component) {
  _inherits(DaySelect, _Component);
  ...
  function DaySelect() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DaySelect.__proto__ || Object.getPrototypeOf(DaySelect)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (evt) {
      _this.props.onChange && _this.props.onChange(evt.target.value);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'option',
          { value: '0' },
          month ? this.props.placeholder : this.props.monthPlaceholder
        ),
        month && (0, _lodash2.default)(1, last).map(function (day) {
          return _react2.default.createElement(
            'option',
            { key: day, value: day },
            day
...
var MonthSelect = function (_Component) {
  ...
  function MonthSelect() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MonthSelect.__proto__ || Object.getPrototypeOf(MonthSelect)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (evt) {
      _this.props.onChange && _this.props.onChange(evt.target.value);
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
...
var YearSelect = function (_Component) {
  ...
  function YearSelect() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = YearSelect.__proto__ || Object.getPrototypeOf(YearSelect)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (evt) {
      _this.props.onChange && _this.props.onChange(evt.target.value);
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(YearSelect, [{
    ...
    value: function render() {
      ...
      var years = (0, _lodash2.default)(this.props.start, this.props.end + 1);

      return _react2.default.createElement(
        'select',
        _extends({}, this.props, { onChange: this.handleChange }),
        _react2.default.createElement(
          'option',
          null,
...
exports.DaySelect = exports.MonthSelect = exports.YearSelect = undefined;

var _YearSelect2 = __webpack_require__(22);

var _YearSelect3 = _interopRequireDefault(_YearSelect2);

var _MonthSelect2 = __webpack_require__(21);

var _MonthSelect3 = _interopRequireDefault(_MonthSelect2);

var _DaySelect2 = __webpack_require__(20);

var _DaySelect3 = _interopRequireDefault(_DaySelect2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.YearSelect = _YearSelect3.default;
exports.MonthSelect = _MonthSelect3.default;
exports.DaySelect = _DaySelect3.default;
